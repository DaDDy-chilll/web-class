...
//Start Fish Func and Bubble Func
(() => {
  fishPosition();
  generateBubble();
})();

// Generate Height of fish positon
...
/**
 * @param {Element of fish} fish
 * @param {Index of fish} index
 * @description index is less than 4 to the right and greather than 4 to left
 */
...
//Create element of image and loop of this element
